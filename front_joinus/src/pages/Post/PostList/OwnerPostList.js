...
const OwnerPostList = () => {
  const [posts, setPosts] = useState([
    { id: 1, title: '오늘은 초여름…내일은 남쪽부터 비구름 올라온다', body: '3일 최고기온이 27도까지 오르면서 중부지방을 중심으로 초여름 날씨를 보이는 곳이 있겠다.낮 최고기온은 18~27도로, 서울, 대전, 강릉 26도, 대구 25도, 광주 23도 등 전국이 다소 덥거나 온화한 날씨를 보이겠다. 기상청은 낮 기온이 오른 만큼 내륙을 중심으로 낮과 밤의 기온 차가 15도 내외로 크게 나타나는 곳도 있으니 건강 관리에 유의할 것을 당부했다.강원도, 경북, 대구 등 동쪽 지역에는 건조주의보가 내려 산불 등 화재 예방에 주의를 기울여야겠다. 건조주의보는 내일(4일)부터 전국에 비가 내리면서 해제될 것으로 보인다. 4일은 전국이 대체로 흐리며 남쪽 지방부터 비가 내리겠다. 전라권과 경남서부는 새벽부터, 수도권과 충청권, 경상권은 오후부터, 밤에는 강원도에도 비가 시작될 전망이다.이번 비는 어린이날(5일)을 포함해 6일 오전까지 길게 이어지면서 강한 바람도 동반할 것으로 보인다. 특히 충남서해안과 전라서해안, 제주도 및 남해안과 경상권 동해안에는 바람이 순간풍속 20㎧(70㎞/s) 이상으로 매우 강하게 불겠고, 전국 대부분 지역에서도 바람이 순간풍속 15㎧(55㎞/s) 내외로 강하게 불겠다.3일 미세먼지는 전 권역 좋음~보통으로 예상된다.', editButton: true, deleteButton: true },
