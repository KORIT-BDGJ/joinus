...
const HostPostList = () => {
  ...
  const getHostApplicantList = useQuery(["getHostApplicantList"], async () => {
      ...
      const response = await axios.get(`https://port-0-joinus-dihik2mlitgq33u.sel4.cloudtype.app/post/${userId}/host/applicant`, option);
      return response.data;
  });
  ...
  const getHostAttendList = useQuery(["getHostAttendList"], async () => {
    ...
    const response = await axios.get(`https://port-0-joinus-dihik2mlitgq33u.sel4.cloudtype.app/post/${userId}/host/attend`, option);
    return response.data;
  });
...
const cancelAttendPost = useMutation(async (postId) => {
  ...
  return await axios.delete(`https://port-0-joinus-dihik2mlitgq33u.sel4.cloudtype.app/post/${postId}/attend/delete`, option);
}, {
    onSuccess: () => {
