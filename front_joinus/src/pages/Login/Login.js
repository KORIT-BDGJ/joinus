...
const Login = () => {
    ...
    const login = useMutation(async (loginUser) => {
        try {
            const response = await axios.post("https://port-0-joinus-koh2xlitnedv8.sel4.cloudtype.app/auth/login", loginUser);
    ...
    const googleAuthClickHandle = () => {
        window.location.href="https://port-0-joinus-koh2xlitnedv8.sel4.cloudtype.app/oauth2/authorization/google";
    }

    const naverAuthClickHandle = () => {
        window.location.href="https://port-0-joinus-koh2xlitnedv8.sel4.cloudtype.app/oauth2/authorization/naver";
    }

    const kakaoAuthClickHandle = () => {
        window.location.href="https://port-0-joinus-koh2xlitnedv8.sel4.cloudtype.app/oauth2/authorization/kakao";
    }
    ...
    return (
        <div css ={ container }>
            ...
            <div css={oauth2Container}>
                <div >
                    <button css={naverButton} onClick={naverAuthClickHandle}></button>
                </div>
                <div>
