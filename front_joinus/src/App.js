  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route
          path="/ownerpostlist"
          element={<AuthRoute path="/ownerpostlist" element={<OwnerPostList />} />}
        />
        <Route
          path="/hostpostlist"
          element={<AuthRoute path="/hostpostlist" element={<HostPostList />} />}
        />
        <Route
          path="/postregister"
          element={<AuthRoute path="/postregister" element={<PostRegister />} />}
        />
